document.addEventListener('DOMContentLoaded', function() {
    ...
    function mostrarDetalhes(ingressoId) {
        ...
        detalhes.innerHTML = `
            ...
            <p><strong>Valor pago:</strong> R$ ${Number(ingresso.valor_total || 0).toFixed(2)}</p>
            <p><strong>Pagamento:</strong> ${ingresso.metodo_pagamento || 'N/A'}</p>
            <p><strong>Status:</strong> ${ingresso.status || 'N/A'}</p>
            <p><strong>ID do pagamento:</strong> ${ingresso.pagamento_id || 'N/A'}</p>
