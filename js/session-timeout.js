// Expira a sessão do usuário após 15 minutos de inatividade

(function () {
    // 1. VERIFICAÇÃO DE ESTADO:
    if (!document.cookie.includes('usuario_nome=')) {
        return;
    }
    ...
    // Inicia a contagem assim que o script é carregado (agora apenas para logados)
    reiniciarTimers();
})();